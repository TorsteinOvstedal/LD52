...
var levels := [
	...
	# {"path": "res://Levels/labyrint1.tscn", "scene": null, "instance": null},
	# {"path": "res://Levels/Labyrint2.tscn", "scene": null, "instance": null}
]
...
func next_level() -> Level:
	if not _is_level(current_level):
		return null
